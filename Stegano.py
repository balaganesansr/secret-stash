            ...
            for i in pix:
                for j in i:
                    ...
                    if dat_place < bin_dat_length:
                        j[0] = int(r[:-1] + bintext[dat_place])
                        dat_place += 1
                    if dat_place < bin_dat_length:
                        j[1] = int(g[:-1] + bintext[dat_place])
                        dat_place += 1
                    if dat_place < bin_dat_length:
                        j[2] = int(b[:-1] + bintext[dat_place])
                        dat_place += 1
                    if dat_place >= bin_dat_length:
                        break
        return pix
...
encodebutton = PhotoImage(file = f"assets\\encodebutton.png")
b0 = Button(
    image = encodebutton,
    borderwidth = 0,
    highlightthickness = 0,
...
decodebutton = PhotoImage(file = f"assets\\decodebutton.png")
b1 = Button(
    image = decodebutton,
    borderwidth = 0,
    highlightthickness = 0,
...
selectimage = PhotoImage(file = f"assets\\selectimage.png")
b2 = Button(
    image = selectimage,
    borderwidth = 0,
    highlightthickness = 0,
...
entry0_img = PhotoImage(file = f"assets\\bigentrybox.png")
...
entry1_img = PhotoImage(file = f"assets\\smallentrybox.png")
